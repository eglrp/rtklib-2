...
//{
//	double x[NX] = { 0 }, dx[NX], Q[NX*NX], *v, *H, *var, sig, dop[4];
...
//
//		/* pseudorange residuals */
//		nv = rescode(i, obs, n, rs, dts, vare, svh, nav, x, opt, v, H, var, azel, vsat, resp,//v = b
//			&ns);
//
//		if (nv<NX) {
...
//
//
//			FILE * fp2 = fopen("signle_position.txt", "a");//打开写入文件
//			if (fp2 == NULL)
//			{
//				perror("fopen");
//			}
...
//		/* doppler residual */
//		float yy = obs[i].D[0];
//		double yy2 = dts[1 + i * 2];
//		v[nv] = -lam * yy - (rate + x[3] - CLIGHT * yy2);
