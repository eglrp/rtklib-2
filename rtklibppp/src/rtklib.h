...
//#define rover_data "COM5:115200:8:n:1:off"
//#define rover_data "192.168.1.8:6003"
...
#define NSYS_USED     2       //number of used satellite systems, GPS/GLO/BDS/GAL/QZS
//append end
...
typedef struct {        /* satellite status type */
	...
	int clkJump;
	int clkJump2;
	double Mp1[MAXPRNGPS][1];
	double Mp2[MAXPRNGPS][1];
	double TEC1[MAXPRNGPS][1];
	double TEC2[MAXPRNGPS][1];
} ssat_t;
